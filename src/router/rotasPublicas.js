const LayoutSite = () => import('@/components/layouts/site/IndexPublico.vue')
import areas from '@/dados/areaAtuacao.json'

const rotasAreas = areas.map(area => ({
  // path: area.slug,
  name: area.titulo,
...
const publico = {
  ...
  children: [
...

    {
      ...
      meta: {titulo: 'Artigos Blog', exibir: true}
    },

    {
      ...
      name: 'Quem somos',
      component: () => import('@/views/Contato.vue'),
      meta: {titulo: 'Quem somos', exibir: true}
    },
...
/*
import LayoutSite from '@/components/layouts/site/IndexPublico.vue'
