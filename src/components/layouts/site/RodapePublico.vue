    ...
    function mousecursor() {
      if ($("body")) {
        ...
        let n,
          i = 0,
          o = !1;
        (globalThis.onmousemove = function (s) {
          o ||
          (t.style.transform =
          ...
          <div class="security"
            ...
            <p>
              ...
              <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 640 512'
                ...
                <title id='svg-inline--fa-title-0OMIlrrQMKA9'>café</title>
                <path fill='currentColor'
            ...
            <p> By <a href="javascript:void(0); " style="color:#FFFFFF" onclick="window.open('http://www.eldermesquita.com.br/');"> e-design </a>
            </p>
          </div>
        </div>
