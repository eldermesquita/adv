        ...
        <div class="row g-4 align-items-center">
              ...
              <div class="contact-info-area-2">
                <div class="contact-info-items mb-4">
                  ...
                  <div class="content">
                    <p>Telefone</p>
                    <h3>
                      <a href="tel:+21214500">(95) 2121-4500</a>
                    </h3>
                  </div>
                </div>
                <div class="contact-info-items mb-4">
                  ...
                  <div class="content">
                    <p>Email</p>
                    <h3>
                      <a href="mailto:infotech@gmail.com">primeirainfancia@tcerr.tc.br</a>
                    </h3>
                  </div>
                </div>
                <div class="contact-info-items border-none">
                  ...
                  <div class="content">
                    <p>Endereço</p>
                    <h3>Av. Cap. Ene Garcez nº 548 - Centro – CEP: 69301-160</h3>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-6">
            <div class="contact-content">
              ...
              <p>Bem-vindo ao nosso site. Estamos felizes em ter você por aqui.</p>
              <p>
                O Tribunal de Contas do Estado de Roraima está sempre aberto ao diálogo com a
                comunidade. Colabore enviando suas dúvidas, críticas e sugestões. Elas serão muito
                bem-vindas.
              </p>
              <br />
              <h3>Horário de funcionamento: 07h30 às 13h30</h3>
